...
Supongamos que compramos varios artículos en el supermercado y queremos obtener
el ticket de venta total incluyendo impuesto.

El sistema solicitó el precio de cada producto a comprar y el usuario debera
indicar su precio (Valor de tipo con punto decimal).
